...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Dexter', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的敲代码学生💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jayzhu.one', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '学习, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'www.jayzhu0011@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 美ICP备123456789', // 备案号 闽ICP备XXXXXXX
